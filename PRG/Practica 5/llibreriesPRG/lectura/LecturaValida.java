...
public class LecturaValida {
    ...
    public static double llegirDoublePos(Scanner tec, String missatge) {
        ...
        do {
            try {
                ...
                System.out.println("Asegura't d'introduir un double valid!"
                                   + " Intenta-ho de nou ...");   
            } finally {
                tec.nextLine();
            }
        } while (hiHaError && res < 0);
        return res;
    }
    ...
    public static int llegirInt(Scanner tec, String missatge) {
        ...
        do {
            try {
                ...
                System.out.println("Asegura't d'introduir un enter valid!" + " Intenta-ho de nou ...");   
            } finally {
                tec.nextLine();
            }
        } while (hiHaError);
     ...
     */    
    public static int llegirInt(Scanner tec, String missatge, int lInferior, int lSuperior) {
        ...
        do {
            try {
                ...
                if(lInferior > res && lSuperior < res){
                    throw new IllegalArgumentException(res + " esta Fora dels limits");
                }
                hiHaError = false;
                
            } catch (InputMismatchException e) {
                System.out.println("Asegura't d'introduir un enter valid entre " + lInferior + " i " + lSuperior  + " Intenta-ho de nou ...");   
